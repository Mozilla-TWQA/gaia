...
from gaiatest.apps.email.app import ToolBar

class TestReceiveActiveSyncEmail(GaiaMtbfTestCase):
	...
	self.toolbar = ToolBar(self.marionette)
	...
	email.launch()
        ...
        if self.toolbar.is_refresh_visible == False:
