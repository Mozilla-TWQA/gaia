...
from gaiatest import GaiaMtbfTestCase
...
class TestCallLogAllCalls(GaiaMtbfTestCase):
    ...
    def test_call_log_all_calls(self):
        ...
        # TODO: might need to add additional check to make sure that call counts +1 already
        self.assertTrue(call_log.all_calls_count > 0, 'call should be recorded')
